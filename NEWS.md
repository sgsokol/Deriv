...
- added `Deriv_cpp()` and `Simplify_cpp()` functions for speed on simple formulas. This can be critical when there are hundreds of formulas to differentiate by tens or hundreds variables. 
