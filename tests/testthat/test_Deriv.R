...
test_that("special functions", {
   ...
   expect_equal_deriv(besselI(x, 1, FALSE), 0.5 * besselI(x, 0, FALSE) + 0.5 * besselI(x, 2, FALSE))
   expect_equal_deriv(besselI(x, 1, TRUE), 0.5 * besselI(x, 0, TRUE) + 0.5 * besselI(x, 2, TRUE)-besselI(x, 1, TRUE))
